...
const aimandscope = () => {
    ...
    return (
        <>
            ...
            {/* <div className="w-full bg-gray-100 p-3 text-sm text-gray-600">
                Home / Journals / <span className="text-blue-500">{journal.journalName}</span>
            </div> */}
            ...
            <div className="w-full mx-auto px-4 py-8 flex flex-row gap-8 bg-white">
                ...
                {/* Main Content */}
                <main className="w-3/4 bg-white p-6 shadow-sm rounded-lg">
                    <div className="flex flex-col bg-gradient-to-r from-blue-50 to-pink-50 md:flex-row items-center md:items-start justify-between border p-4 bg-gray-100 rounded-md">
